package com.example.cursomc.resources.validation.util;
...
public class BR {
	    ...
	    // CNPJ
	    private static final int[] WEIGHT_cpf = {6, 5, 4, 3, 2, 9, 8, 7, 6, 5, 4, 3, 2};
	    ...
	    private static boolean checkEquals(String cpf, int length, int[] weight) {
	        final String number = cpf.substring(0, length);
	        final int digit1 = calculate(number, weight);
	        final int digit2 = calculate(number + digit1, weight);
	        return cpf.equals(number + digit1 + digit2);
	    }
	    ...
	    public static boolean isValidCnpj(String cnpj) {
	        ...
	        return checkEquals(cnpj, 12, WEIGHT_cpf);
	    }
